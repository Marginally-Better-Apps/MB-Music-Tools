...
class PullRequestWorkflowTests(unittest.TestCase):
    ...
    def test_pr_ipa_publishes_a_tappable_autoloader_preview(self) -> None:
        ...
        shim = (ROOT / "scripts" / "write-autoloader-page.py").read_text()
        self.assertIn("marginally-better-apps.github.io/Autoloader", shim)
        self.assertIn("https_shim_url", shim)
